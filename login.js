...
const lecturerRoleBtn = document.getElementById("lecturer-role-btn");

const studentLogin = document.getElementById("student-login");
const lecturerLogin = document.getElementById("lecturer-login");

const studentEnterBtn = document.getElementById("student-enter-btn");
...
const lecturerPassword = document.getElementById("lecturer-password");
...
studentRoleBtn.addEventListener("click", () => {
    ...
    studentLogin.classList.remove("hidden-login");
    lecturerLogin.classList.add("hidden-login");
...
lecturerRoleBtn.addEventListener("click", () => {
    ...
    lecturerLogin.classList.remove("hidden-login");
    studentLogin.classList.add("hidden-login");
...
studentEnterBtn.addEventListener("click", () => {
    ...
    localStorage.setItem("dataQuestzRole", "student");
...
lecturerLoginBtn.addEventListener("click", () => {
    ...
    const username = lecturerUsername.value.trim();
    ...
    if (
        ...
        localStorage.setItem("dataQuestzRole", "lecturer");
